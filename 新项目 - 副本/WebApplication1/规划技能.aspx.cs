...
{
    public partial class 规划技能 : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            string SqlStr = "insert into Comment(Email,Label,Comment,ReplyNum,UserName,ReadNum) values('" + Session["Email"] + "','技能','" + neirong + "','0','" + Session["UserName"] + "','0')";
            db.charu(SqlStr);
            this.TextBox1.Text = "";
            Response.Write("<script>alert('添加成功！');location='规划技能.aspx'</script>");
        }
        public void DataListBind()
        {
            ...
            DB db = new DB();
            //定义SQL语句
            string sqlstr = "select * from Comment where UserName = '" + Session["UserName"] + "' and Label='技能' "; /* UserName = '" + Session["UserName"]+ "' and  */
