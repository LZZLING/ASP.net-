<%@ Page Title="" Language="C#" MasterPageFile="~/母个人中心.master" AutoEventWireup="true" CodeBehind="个生活.aspx.cs" Inherits="WebApplication1.个生活" %>
<asp:Content ID="Content1" ContentPlaceHolderID="mugerenzhongxin" runat="server">
	...
	<div class="row clearfix  ">
		...
		<div class="col-12 column  border-bottom  ">
			<div class="mt-3 pull-right " style="background-color:white;border:1px solid white;border-radius:5px">
				<div class=" p-2  " >
