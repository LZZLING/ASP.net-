<%@ Page Title="" Language="C#" MasterPageFile="~/母规划.master" AutoEventWireup="true" CodeBehind="规划技能.aspx.cs" Inherits="WebApplication1.规划技能" %>
							...
							<table class="table table-borderless">
                                <thead>
                                        <tr style="border-bottom: 2px solid gainsboro;">
                                            <td ><h3 style="color: #808080">技能锻炼</h3></td>
											...
											<div class="mt-3 " style="background-color:#f2f2f2;border:1px solid  white;border-radius:5px">
												<div class="row">
													<div class=" col-1 text-muted ">
														<h6 style="white-space:nowrap;color:#99ccff">技能</h6>
													</div>
