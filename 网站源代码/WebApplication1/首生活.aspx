<%@ Page Title="" Language="C#" MasterPageFile="~/母首页.master" AutoEventWireup="true" CodeBehind="首生活.aspx.cs" Inherits="WebApplication1.首生活" %>
<asp:Content ID="Content2" ContentPlaceHolderID="mushouye" runat="server">
		...
		<script type="text/javascript">
            $(function () {
                $(".gz").mousemove(function () {
                    ...
                    $(this).siblings().find(".nav-link").removeClass("active");    // .siblings() 返回被选元素的所有同级元素（其余）。
                });
            });
            //$(function () {
					...
					<div style="border-bottom: 2px solid gainsboro;">
						<ul class="nav nav-tabs" id="shougongzuo">
                            <li class="gz nav-item   btn-sm" >
								<asp:Button ID="b1" runat="server" Text="最新" class="nav-link   " OnClick="b1_Click" />
                                <%--<button id="b1" runat="server"  value="最新" class="nav-link text-primary" style="color:black" >最新</button>--%>
                              
                            </li>
                            <li class="gz nav-item btn-sm">
                                <asp:Button ID="b2" runat="server" Text="最热" class="nav-link "  OnClick="b2_Click" />
                            </li>
                            <li class="gz nav-item btn-sm">
                                <asp:Button ID="b3" runat="server" Text="精选" class="nav-link "  OnClick="b3_Click" />
                            </li>
                        </ul>
					</div>
							...
							<ItemTemplate >
								<div style="border-bottom:2px solid #737373;" >
									...
									<button type="button" class="btn  btn-success" style="padding: 3px 5px;font-size: 12px;line-height: 1.5;border-radius: 3px;" >
										<asp:Label ID="lbLable" runat="server" Text="生活" ></asp:Label>
									</button>
