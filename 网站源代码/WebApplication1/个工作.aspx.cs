...
{
    public partial class 个工作 : System.Web.UI.Page
    {
        ...
        public void Bind(int CurrentPage)
        {
            ...
            //在这里填充datalist
            string SqlStr = "select * from Comment where Label='工作'and UserName = '" + Session["UserName"] + "'  order by time DESC";    /*测试时不要这个快些*/
            //实例化数据集DataSet
