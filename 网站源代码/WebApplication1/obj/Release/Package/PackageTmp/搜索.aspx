<%@ Page Title="" Language="C#" MasterPageFile="~/母首页.master" AutoEventWireup="true" CodeBehind="搜索.aspx.cs" Inherits="WebApplication1.搜索" %>
							...
							<ItemTemplate >
								<div style="border-bottom:2px solid #737373;" >
									...
									<button type="button" class="btn  btn-success" style="padding: 3px 5px;font-size: 12px;line-height: 1.5;border-radius: 3px;" >
										<asp:Label ID="lbLable" runat="server" Text='<%# Eval("Label") %>' ></asp:Label>
									</button>
