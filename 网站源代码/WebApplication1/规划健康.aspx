<%@ Page Title="" Language="C#" MasterPageFile="~/母规划.master" AutoEventWireup="true" CodeBehind="规划健康.aspx.cs" Inherits="WebApplication1.规划健康" %>
<asp:Content ID="Content1" ContentPlaceHolderID="muguihua" runat="server">
    <div class="container" style="background-color:#f2f2f2">
			<div class="row clearfix  ">
				<div class="col-12 column  border-bottom ">
					<div class="mt-3 " style="background-color:white;border:1px solid white;border-radius:20px">
						<div class="jumbotron" >
				            <h1 style="color:  #4d4d4d" >
					            &nbsp;&nbsp;规划你的人生
				            </h1>
				            <p style="text-decoration:none;color:  #b3b3b3">
				...
				<div class="col-12 column  border-bottom ">
					<div class="mt-3 " style="background-color:white ;border:1px solid white;border-radius:10px;">
						<div class=" p-2 ">
							<table class="table table-borderless">
                                <thead>
                                        <tr style="border-bottom: 2px solid gainsboro;">
                                            <td ><h3 style="color: #808080">保持健康</h3></td>
                                    ...
                                    <asp:DataList ID="DataList1" runat="server" Width="100%"  RepeatDirection="Horizontal" RepeatColumns="3" OnEditCommand="DataList1_EditCommand" OnItemCommand="DataList1_ItemCommand" OnCancelCommand="DataList1_CancelCommand" OnUpdateCommand="DataList1_UpdateCommand">
										<ItemTemplate >
											<div class="mt-3 " style="background-color:#f2f2f2;border:1px solid  white;border-radius:5px">
												<div class="row">
													<div class=" col-1 text-muted ">
														<h6 style="white-space:nowrap;color:#99ccff">健康</h6>
													</div>
